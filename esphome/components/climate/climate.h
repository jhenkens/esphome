...
class Climate : public EntityBase {
 public:
  ...
  void set_temperature_unit_override(ClimateTemperatureUnit temperature_unit_override);
#endif
...
#endif
#ifdef USE_CLIMATE_TEMPERATURE_UNIT
  ClimateTemperatureUnit temperature_unit_override_{CLIMATE_TEMPERATURE_UNIT_UNSET};
#endif
